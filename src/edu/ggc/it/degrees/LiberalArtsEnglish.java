//*******************************************************************
// Class: LiberalArtsEnglish
//
// This class is used to retrieve and display the program plans
// for each program in the Liberal Arts - English major.
//
...
public class LiberalArtsEnglish extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button goBack = (Button) findViewById(R.id.english_back);
		goBack.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				Intent intent = new Intent(LiberalArtsEnglish.this, LiberalArts.class);
				LiberalArtsEnglish.this.startActivity(intent);
