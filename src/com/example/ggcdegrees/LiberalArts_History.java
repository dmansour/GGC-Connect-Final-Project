...
public class LiberalArts_History extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		go_back_button.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				Intent intent = new Intent(LiberalArts_History.this, LiberalArts.class);
				LiberalArts_History.this.startActivity(intent);
