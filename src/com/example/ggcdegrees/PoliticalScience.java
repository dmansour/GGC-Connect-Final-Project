...
public class PoliticalScience extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button AmeriGov = (Button) findViewById(R.id.americanGovt);
		...
		Button ComparePol = (Button) findViewById(R.id.comparePolotics);
		...
		Button InternRelations = (Button) findViewById(R.id.interRelations);
		...
		Button go_back_button = (Button) findViewById(R.id.polotics_back);
		go_back_button.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				Intent intent = new Intent(PoliticalScience.this, LiberalArts.class);
				PoliticalScience.this.startActivity(intent);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.political_science, menu);
		return true;
	}
